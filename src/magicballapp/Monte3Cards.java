...
public class Monte3Cards {
	...
	public static void main(String[] args) {
		...
		Random r = new Random();
		while (myGame.getCurrentCash() < maxWin && myGame.getCurrentCash() >miniLose) {
				// Roll it
				do {
				...
				} while (yourBet < miniBet || yourBet > yourCash);
				// action
				...
				if (acePosition==guessPosition) {
					...
					//you lost
				    System.out.println(lostWord + acePosition + ".\n");
					myGame.displayCover(acePosition);
					myGame.setCurrentCash( myGame.getCurrentCash() - yourBet); 
				}
		}
